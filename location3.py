...
iframe1 = branca.element.IFrame(html=html1, width=400, height=400)
folium.Marker(location=[36.65139, 138.18111], popup=folium.Popup(iframe1, max_width=400)).add_to(m)
...
img2 = 'https://blog.osakanight.com/img/kyusakaitodai_lightup01.jpg'
html2 = FORMAT_IMG.format(src=img2)
iframe2 = branca.element.IFrame(html=html2, width=400, height=400)
folium.Marker(location=[34.583465, 135.458955], popup=folium.Popup(iframe2, max_width=400)).add_to(m)
...
img3= 'https://www.starflyer.jp/tourism/yamaguchi_magic/tsunoshima/img/img_main_01_01.jpg'
html3 = FORMAT_IMG.format(src=img3)
iframe3 = branca.element.IFrame(html=html3, width=400, height=400)
folium.Marker(location=[34.352585, 130.840947], popup=folium.Popup(iframe3, max_width=400)).add_to(m)
