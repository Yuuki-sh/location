...
iframe1 = branca.element.IFrame(html=html1, width=310, height=310)
...
iframe2 = branca.element.IFrame(html=html2, width=310, height=310)
folium.Marker(location=[34.583465, 135.458955], popup=folium.Popup(iframe2)).add_to(m)
...
iframe3 = branca.element.IFrame(html=html3, width=310, height=310)
folium.Marker(location=[34.352585, 130.840947], popup=folium.Popup(iframe3)).add_to(m)
