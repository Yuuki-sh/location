...
iframe2 = branca.element.IFrame(html=html2, width=250, height=250)
folium.Marker(location=[34.583465, 135.458955], popup=folium.Popup(iframe2, max_width=250)).add_to(m)
...
iframe3 = branca.element.IFrame(html=html3, width=250, height=250)
folium.Marker(location=[34.352585, 130.840947], popup=folium.Popup(iframe3, max_width=250)).add_to(m)
