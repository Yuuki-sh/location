...
#detail of gphotos
#https://gilesknap.github.io/gphotos-sync/main/tutorials/installation.html#execute-in-a-container
...
iframe1 = branca.element.IFrame(html=html1) #, width=300, height=300)
folium.Marker(location=[36.65139, 138.18111], popup=folium.Popup(iframe1, max_width=300)).add_to(m)
...
img2 = 'https://registphotos-n7squslrhundwwa8esakgd.streamlit.app/~/+/media/7ef39547357eaac780c0ff71cfdaa086339f4b9bc1d46ad12526e2f2.jpg'
html2 = FORMAT_IMG.format(src=img2)
iframe2 = branca.element.IFrame(html=html2) #, width=300, height=300)
folium.Marker(location=[34.583465, 135.458955], popup=folium.Popup(iframe2, max_width=300)).add_to(m)
...
img3= 'https://registphotos-n7squslrhundwwa8esakgd.streamlit.app/~/+/media/c571578b92bf76f2a51c3fd257774ad5073516529b45971d5062f216.jpg'
html3 = FORMAT_IMG.format(src=img3)
iframe3 = branca.element.IFrame(html=html3, width=300, height=300)
folium.Marker(location=[34.352585, 130.840947], popup=folium.Popup(iframe3, max_width=300)).add_to(m)
